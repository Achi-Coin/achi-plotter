...
#ifndef INCLUDE_ACHI_PHASE1_HPP_
#define INCLUDE_ACHI_PHASE1_HPP_

#include <achi/phase1.h>
#include <achi/ThreadPool.h>
#include <achi/DiskTable.h>
#include <achi/bits.hpp>
...
public:
    ...
    void evaluate(const T& L, const T& R, S& entry) const
    {
        ...
        blake3_hasher_update(&hasher, "achi plot", 9);
...
#endif /* INCLUDE_ACHI_PHASE1_HPP_ */

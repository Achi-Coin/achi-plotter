...
#ifndef INCLUDE_ACHI_DISKSORT_HPP_
#define INCLUDE_ACHI_DISKSORT_HPP_

#include <achi/DiskSort.h>
...
{
	const size_t index = Key{}(entry) >> key_shift; // entry.y >> key_shift = 132
...
#endif /* INCLUDE_ACHI_DISKSORT_HPP_ */
